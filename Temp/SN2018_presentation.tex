...
\includegraphics[width=41mm,viewport=75 37 440 590,clip=]{KeyRouteW.pdf}
\includegraphics[width=50mm,viewport=182 34 633 490,clip=]{Island4w.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\textwidth,viewport=30 140 755  660,clip=]{CoPairs.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=\textwidth]{CiteAlineweights.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=0.9\textwidth,viewport=10 0 1045 705 740,clip=]{JJsfmain2.pdf}
\end{center}
...
\begin{frame}[fragile]
\frametitle{The most cited works\label{maxinb}\\ \normalsize indegree in CiteR}
